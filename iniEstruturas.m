...
bloomFilter = BloomFilter(100000,5);
u2 = u2(u2(:,2) >= 3,1);
...
save data.mat userMoviesSignaturesMatrix moviesGenreSignaturesMatrix utiliz bloomFilter C dic moviesNameSignaturesMatrix
